...
srun --job-name=${accnum} kraken2 --paired --gzip-compressed --report ./data/kraken2_reports/${accnum}.report  --threads ${SLURM_CPUS_PER_TASK}  --db /shared/projects/form_2022_19/kraken2/arch_bact_vir_hum_protoz_fung/   --output ./data/kraken2_output/${accnum}_results.tsv  ${input_file_1} ${input_file_2}
